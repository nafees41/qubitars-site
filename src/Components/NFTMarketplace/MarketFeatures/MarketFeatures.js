    ...
    <div className="container mt-5">
        <div className="row">
            <div className="col-md-6">
                ...
                Qubitars Technology’s diverse team with its vast experience is offering a whole set of Features related to NFT Marketplace.
                ...
                <div className="wordpress_right">
                  ...
                  <div className="wordpress_right">
                      <img
                          ...
                          loading="lazy"
                      />
                          <span>  No Third Party Invention</span>
                          <hr className="w_banner_line" />
                  ...
                  <div className="wordpress_right">
                      <img
                          ...
                          loading="lazy"
                      />
                          <span> Tailored Smart Contract</span>
                          <hr className="w_banner_line" />
                  ...
                  <div className="wordpress_right">
                      <img
                          ...
                          loading="lazy"
                      />
                          <span> Fractionalization of Larger Assets</span>
                          <hr className="w_banner_line" />
